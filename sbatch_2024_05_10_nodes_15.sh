...
# 执行PyTorch分布式训练命令
# srun bash -c "torchrun --nproc_per_node=3 --nnodes=15 --node_rank=\$SLURM_NODEID --master_addr=$MASTER_ADDR --master_port=29500 pretrain_2024-05-13_distributed.py --data_path='./data/panglao_human.h5ad'"
