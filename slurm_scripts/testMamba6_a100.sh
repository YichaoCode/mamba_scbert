#!/bin/bash
#SBATCH --job-name=MambaTest_a100_3_6_batch18    # 作业名称
#SBATCH --nodes=6                   # 请求的节点数
...
srun bash -c "torchrun --nproc_per_node=3 --nnodes=6 --node_rank=\$SLURM_NODEID --master_addr=$MASTER_ADDR --master_port=29500 pretrain_modify_mamba.py --batch_size 18 --data_path='./data/panglao_human.h5ad' 2>&1"
