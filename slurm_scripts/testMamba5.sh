#!/bin/bash
#SBATCH --job-name=MambaTest    # 作业名称
...
srun bash -c "torchrun --nproc_per_node=1 --nnodes=1 --node_rank=\$SLURM_NODEID --master_addr=$MASTER_ADDR --master_port=29500 pretrain_modify_mamba.py --batch_size 3 --data_path='./data/panglao_human.h5ad' 2>&1"
