...
srun bash -c "torchrun --nproc_per_node=3 --nnodes=2 --node_rank=\$SLURM_NODEID --master_addr=$MASTER_ADDR --master_port=29500 \
pretrain_wandb_10_02.py --data_path='./data/panglao_human.h5ad' --model_type=mamba"
